...
public class ProductDao {
	...
	// Constructor for the ProductDao class to initialize the database connection

	public ProductDao() {
		conn = DBConnect.getConnection();
	}
	//takes list of  products as input and inserts each order into the database 
...
//updates the stock quantity of a product
	...
	//retrieves products based on their category
