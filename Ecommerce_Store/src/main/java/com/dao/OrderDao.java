...
public class OrderDao {
	// Constructor for the OrderDao class to initialize the database connection
	private Connection conn;
	// Constructor for the OrderDao class to initialize the database connection
	public OrderDao() {
		conn = DBConnect.getConnection();
	}
	//takes list of  objects as input and inserts each order into the database 
	...
	//This method takes an order status and order ID as input and updates the status of the order 
	...
	//This method takes a user ID as input and returns a List of ProductOrder objects corresponding to orders made by that user.
	...
	//This method returns a List of all ProductOrder objects in the database.
